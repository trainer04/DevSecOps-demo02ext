...
- Set "GitHub project" with an URL to the project (like "https://github.com/trainer04/DevSecOps-demo02.git")<br>
- Set "Definition" with "Pipeline script from SCM"<br>
- Set "SCM" as "Git"<br>
- Set "Repository URL" with your URL (like "https://github.com/trainer04/DevSecOps-demo02.git")<br>
...
To speed-up some network-related operations, the pipene includes proxy configuration, saved in Jenkins credentials store<br>
If you do not use any proxies, just comment or remove the related parameters from the Jenkinsfile, like<br>
